...
import com.jvt.devthread.cryptoworld.databinding.FragmentAllMarketBinding;
...
public class AllMarket extends Fragment {
    private FragmentAllMarketBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentAllMarketBinding.inflate(inflater,container,false);
        View view = binding.getRoot();
        currencyAdapter = new CurrencyAdapter(getContext(),currencyModelArrayList);
        binding.allRecycler.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.allRecycler.setAdapter(currencyAdapter);
        getCurrencyData();
