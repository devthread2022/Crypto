...
import com.jvt.devthread.cryptoworld.databinding.FragmentMarketLoosersBinding;
...
public class MarketLoosers extends Fragment {
    private FragmentMarketLoosersBinding binding;
    private ArrayList<CurrencyModel> currencyModelArrayList = new ArrayList<>();
    private CurrencyAdapter currencyAdapter;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        binding = FragmentMarketLoosersBinding.inflate(inflater,container,false);
        View view = binding.getRoot();
        currencyAdapter = new CurrencyAdapter(getContext(),currencyModelArrayList);
        binding.loserRecycler.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.loserRecycler.setAdapter(currencyAdapter);
        getCurrencyData();
        return view;
    }
