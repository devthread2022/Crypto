...
public class PopularSellingAdapter extends RecyclerView.Adapter<PopularSellingAdapter.ViewHolder> {
    public Context context;
    private List<CurrencyModel> currencyModelList;
    private static DecimalFormat decimalFormat = new DecimalFormat("#.##");

    public PopularSellingAdapter(Context context, List<CurrencyModel> currencyModelList) {
